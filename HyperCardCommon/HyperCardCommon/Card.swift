...
public class Card: Layer {
    ...
    public let backgroundProperty: Property<Background>
    ...
    public let markedProperty = Property<Bool>(false)
    ...
    public let searchHashProperty = Property<SearchHash?>(nil)
    ...
    public let backgroundPartContentsProperty = Property<[BackgroundPartContent]>([])
