...
public class Layer {
    ...
    public let imageProperty = Property<MaskedImage?>(nil)
    ...
    public let showPictProperty = Property<Bool>(true)
    ...
    public let partsProperty = Property<[LayerPart]>([])
    ...
    public let nextAvailablePartIdentifierProperty = Property<Int>(1)
