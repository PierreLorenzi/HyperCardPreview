...
private let caseTransform = { (c: HChar) -> HChar in return lowercaseTable[Int(c)] }
private let caseDiacriticTransform = { (c: HChar) -> HChar in return lowercaseNoAccentTable[Int(c)] }
...
private let lowercaseTable: [HChar] = [
    0x00,
    0x01,
    0x02,
    0x03,
