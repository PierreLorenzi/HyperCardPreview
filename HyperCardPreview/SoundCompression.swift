...
/* Algorithm taken in the 'mace.c' file of the FFmpeg library
 Here are the comments printed in the original file: */
/*
 * MACE decoder
...
extension MaceCompressionType {
    
    static func uncompressSound(in data: DataRange, type: MaceCompressionType, frameCount: Int, channelCount: Int) -> [[Int16]] {
        
        var result: [[Int16]] = []
        
        let frameSize = getFrameSize(of: type)
    ...
    private static let MACEtab1: [Int16] = [-13, 8, 76, 222, 222, 76, 8, -13]

    private static let MACEtab3: [Int16] = [-18, 140, 140, -18]

    private static let MACEtab2: [Int16] = [
    ...
    private static let MACEtab4: [Int16] = [
    ...
    private static let tabs: [Tab] = [
        Tab(tab1: MACEtab1, tab2: MACEtab2, stride: 4),
        Tab(tab1: MACEtab3, tab2: MACEtab4, stride: 2),
        Tab(tab1: MACEtab1, tab2: MACEtab2, stride: 4),
    ]
    ...
    private struct MACEContext {
        var chd: [ChannelData]
    }
    
    private static func QT_8S_2_16S(_ x: Int16) -> Int16 {
        // -256 was 0xFF00
        return (((x) & -256) | (((x) >> 8) & 0xFF))
    }

    private static func mace_broken_clip_int16(_ n: Int) -> Int16 {
    ...
    private static func read_table(_ chd: inout ChannelData, _ val: Int16, _ tab_idx: Int) -> Int16 {
    ...
    private static func chomp3(_ chd: inout ChannelData, _ val: Int16, _ tab_idx: Int) -> Int16 {
    ...
    private static func chomp6(_ chd: inout ChannelData, _ val: Int16, _ tab_idx: Int) -> (Int16, Int16) {
    ...
    private static func getFrameSize(of type: MaceCompressionType) -> Int {
